...
const MANAGERS: Manager[] = [
  ...
  { id: 2, name: "Валерия Филиппова", role: "Директор", avatar: "💎", stars: 5, points: 7200, reviews: 89, specialty: "Продажи аккаунтов, работа с клиентами", tg: "https://t.me/live_your_life_with_worthiness" },
